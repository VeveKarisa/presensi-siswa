        ...
        <div className="sm:flex sm:items-start">
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
            ...
            <div className="bg-gray-50 px-4 sm:px-6 sm:flex sm:flex-row-reverse">
              <button
                type="button"
                className="inline-flex w-full justify-center rounded-md border border-transparent bg-[#D40B0B] hover:bg-red-700 px-4 py-1 text-base font-medium text-white shadow-sm sm:ml-3 sm:w-auto sm:text-sm"
                onClick={onClose}
              >
                Tutup
              </button>
