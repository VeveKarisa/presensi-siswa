          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="mt-2">
                  <form className='my-7'>
                    <div className='border bg-white p-7 rounded-md'>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                          <label for="password" class="mb-2 text-md font-medium text-gray-900s hidden">Konfir Password</label>
                          <input type="password" id="password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg block w-full p-2.5" placeholder="Konfirmasi Password" required />
                      </div>
                      <div class="mb-3">
                          <label for="password" class="mb-2 text-md font-medium text-gray-900s hidden">Konfir Password</label>
                          <select id="password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg block w-full p-2.5" required>
...
const Regis = () => {
  ...
  return (
    <div>
      <h1 className="w-full text-center my-12 text-gray-500 text-xl font-medium">Registrasi Akun User</h1>
      <div className="lg:ml-72 lg:mr-44 mb-5">
        <div className="flex justify-between">
          <button className="bg-[#1D48A6] hover:bg-blue-900 text-white flex items-center gap-4 px-5 rounded-md shadow-md" onClick={toggleModal}>
            Tambah User
