            ...
            <div className='w-full justify-end flex'>
                ...
                <div className="flex gap-16 p-7 items-center">
                    ...
                    <div className="w-1/2">
                        ...
                        <p className="text-[#9E9898] text-md">NIP <span className='ml-14 mr-2'>:</span><span className='font-bold text-black'>123456</span></p>
                        <p className="text-[#9E9898] text-md">Email <span className='ml-11 mr-2'>:</span><span className='font-bold text-black'>Jiso@email.com</span></p>
                        ...
                        <p className="text-[#9E9898] text-md">Kelas <span className='ml-12 mr-2'>:</span><span className='font-bold text-black'>4a</span></p>
                    </div>
                </div>
                  ...
                  <h1 className='font-bold text-2xl text-[#9E9898] text-center'>DATA DIRI</h1>
                    <div className="flex gap-24 py-7 px-16 items-center">
                        ...
                        <div className="w-1/2">
                            ...
                            <hr className="border-[#9E9898] my-2" />
                            <p className="text-[#9E9898] text-md">NIP <span className='ml-14'>:</span></p>
                            <p className="text-[#9E9898] text-md">Email <span className='ml-11'>:</span></p>
                            <p className="text-[#9E9898] text-md">No Telp <span className='ml-7'>:</span></p>
                            <p className="text-[#9E9898] text-md">Kelas <span className='ml-11'>:</span></p>
                        </div>
                    </div>
                </div>
