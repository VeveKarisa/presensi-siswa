                                ...
                                <ul className="space-y-2 pb-2">
                                    ...
                                    <li>
                                        <button id="submenuButton" onClick={toggleSubMenu} className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                            ...
                                            <span className="ml-3 font-medium text-gray-500">Data Kelas</span>
                                            <p></p>
                                        </button>
                                        {showSubMenu && (
                                            <div className="z-10 divide-y divide-gray-100s">
                                                <ul className="py-2 text-sm text-gray-700">
                                                    <li>
                                                        <a href="data_siswa" className="block px-4 py-2 border rounded-md hover:bg-gray-100 mb-2">Data Siswa</a>
                                                    </li>
                                                    <li>
                                                        <a href="absensi" className="block px-4 py-2 border rounded-md hover:bg-gray-100">Absensi</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        )}
